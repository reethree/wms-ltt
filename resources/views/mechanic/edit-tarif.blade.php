...
<div class="box box-default">
    <div class="box-header with-border">
      <h3 class="box-title">Edit Tarif Mechanic</h3>
    </div>
    <!-- /.box-header -->
    <form class="form-horizontal" action="{{ route('mechanic-tarif-update', $tarif->id) }}" method="POST">
        <div class="box-body">            
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                          <input type="text" name="name" class="form-control" id="name" required value="{{$tarif->name}}">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group">
                                ...
                                <input type="number" id="tarif1" name="tarif1" class="form-control pull-right" value="{{$tarif->tarif1}}"> 
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group">
                                ...
                                <input type="number" id="tarif2" name="tarif2" class="form-control pull-right" value="{{$tarif->tarif2}}"> 
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group">
                                ...
                                <input type="number" id="tarif3" name="tarif3" class="form-control pull-right" value="{{$tarif->tarif3}}"> 
                            </div>
                        </div>
                    </div>
                </div>
