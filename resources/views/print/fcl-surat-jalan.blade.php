...
@section('content')
    ...
    <div id="details" class="clearfix">
        ...
        <table border="1" cellspacing="0" cellpadding="0">
            ...
            <tbody>
                <tr>
                    <td style="width: 25%;vertical-align: top;">{{ $container->KODE_DOKUMEN }}<br/>{{$container->NO_SPPB.' '.$container->TGL_SPPB}}</td>
                    <td style="width: 10%;text-align: center;vertical-align: top;">{{ $container->SIZE }}</td>
                    <td style="width: 10%;text-align: center;vertical-align: top;">{{ $container->TEUS }}</td>
